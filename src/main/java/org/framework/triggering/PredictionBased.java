 ...
 * @since 12/26/16
 */
public class PredictionBased {

    private static Logger logger = DynamicVMP.getLogger();

    private PredictionBased() {
        // Default Constructor
    }
     ...
     */
    public static void PredictionBasedManager(List<Scenario> workload, List<PhysicalMachine> physicalMachines,
                                              List<VirtualMachine>
        ...
        StaticReconfMemeCall staticReconfgTask;
