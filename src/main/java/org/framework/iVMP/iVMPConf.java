...
public class iVMPConf {
    ...
    private static Algorithm[] heuristics = new Algorithm[]{
            ...
            BestFit::bestFit,
            WorstFit::worstFit,
            FirstFit::firstFit,  // First Fit Decreasing
            BestFit::bestFit,   // Worst Fit Decreasing
     ...
     */
    public static boolean allocateVMToDC(final VirtualMachine vm, final List<PhysicalMachine> physicalMachines,
